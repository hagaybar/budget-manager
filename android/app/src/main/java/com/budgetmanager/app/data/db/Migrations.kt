...
val MIGRATION_1_2 = object : Migration(1, 2) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        // 3. Recreate recurring_transactions with FK constraint on budget_id
        ...
        db.execSQL("""
            ...
            SELECT `id`, `type`, `amount`, `category`, `description`, `frequency`, `day_of_week`, `day_of_month`, `start_date`, `end_date`, `is_active`, `created_at`, 0
        ...
        // 4. Recreate transactions with FK constraints on both recurring_id and budget_id
        db.execSQL("""
        ...
        db.execSQL("""
            ...
            SELECT `id`, `type`, `amount`, `category`, `description`, `date`, `created_at`, `recurring_id`, 0
            FROM `transactions`
        """)
